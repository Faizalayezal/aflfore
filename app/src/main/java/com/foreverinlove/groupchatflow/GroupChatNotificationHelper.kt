...
class GroupChatNotificationHelper(uploadFileProgress: GroupChatViewModel.UploadFileProgress, name:String, context: Context) {
    ...
    init {
        ...
        when(val state=uploadFileProgress.data){
            is GroupChatViewModel.UploadStatus.Failed -> {
            ...
            is GroupChatViewModel.UploadStatus.InProgress -> {
                val notificationBuilder: Notification.Builder = Notification.Builder(context)
            ...
            is GroupChatViewModel.UploadStatus.Successful -> {
                val notificationBuilder: Notification.Builder = Notification.Builder(context)
                notificationBuilder.setOngoing(false)
